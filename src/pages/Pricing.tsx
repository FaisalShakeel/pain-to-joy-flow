...
const tiers = [
  ...
  { id: "personal", name: "Personal", price: "$130", per: "per year · $91 with Early Supporter Offer", blurb: "For professionals who value attention.", perks: ["Direct Call Sync", "Ping feature", "Smart routing & priority contacts", "Quiet hours & focus modes"], cta: "Choose Personal", to: "/app/upgrade", best: false },
